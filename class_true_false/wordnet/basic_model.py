...
class BaseLSTM(nn.Module):
    ...
    def __init__(self, input_size=1, hidden_size=100, batch_size=64):
        ...
        self.linear1 = nn.Linear(4 * self.hidden_size + 1, 4 * self.hidden_size + 1)
        self.linear2 = nn.Linear(4 * self.hidden_size + 1, 2)

    def forward(self, caption, obj, dist):
        ...
        h_combined = torch.cat([h_cap, h_obj, dist], 1)
